...
<div class="container-fluid py-4">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h1 class="h3"><i class="fas fa-calendar-alt text-success"></i> Planning Jardinage</h1>
            <?php if ($canManage): ?>
            ...
            <div class="row g-2 align-items-center">
                <div class="col-auto">
                    <div class="btn-group btn-group-sm">
                        ...
                        <button class="btn btn-outline-success" id="today-btn">Aujourd'hui</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    <div class="col-12"><label class="form-label">Titre <span class="text-danger">*</span></label><input type="text" class="form-control" id="shiftTitle" placeholder="Ex : Taille des haies"></div>
                    ...
                    <div class="col-md-6"><label class="form-label">Catégorie</label>
                        <select class="form-select" id="shiftCategory">
                            <?php foreach ($categories as $c): ?>
                                <option value="<?= $c['id'] ?>" <?= ($c['slug'] ?? '') === 'jardinage' ? 'selected' : '' ?>><?= htmlspecialchars($c['nom']) ?></option>
                            <?php endforeach; ?>
                        </select></div>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" id="btnSaveShift" onclick="saveShift()"><i class="fas fa-save me-1"></i>Enregistrer</button>
            </div>
        </div>
    </div>
</div>
...
<script>
const BASE = '<?= BASE_URL ?>';
const AJAX_URL = BASE + '/jardinage/planningAjax';
