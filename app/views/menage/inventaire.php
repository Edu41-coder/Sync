...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-boxes-stacked me-2 text-info"></i>Inventaire Ménage
    ...
    <div class="card shadow-sm mb-4 border-info">
        ...
        <div class="card-body">
            <form method="POST" action="<?= BASE_URL ?>/menage/inventaire/ajouter" class="row g-2 align-items-end">
                ...
                <div class="col-md-3"><label class="form-label small">Emplacement</label><input type="text" name="emplacement" class="form-control form-control-sm" placeholder="Local technique, buanderie..."></div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body p-0">
            <table class="table table-hover mb-0" id="inventaireTable">
                <thead><tr><th>Produit</th><th>Section</th><th class="text-center">Stock</th><th class="text-center">Seuil</th><th>Emplacement</th><th class="text-center">Actions</th></tr></thead>
                <tbody>
                    ...
                    <tr class="<?= $isAlerte ? 'table-danger' : '' ?>">
                        ...
                        <td><span class="badge bg-info"><?= ucfirst(str_replace('_',' ',$i['section'] ?? '-')) ?></span></td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= BASE_URL ?>/menage/inventaire/historique/<?= $i['id'] ?>" class="btn btn-sm btn-outline-secondary" title="Historique"><i class="fas fa-history"></i></a>
                        </td>
                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" id="formMvt">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button><button type="submit" class="btn btn-info"><i class="fas fa-save me-2"></i>Valider</button></div>
            </form>
        </div>
    </div>
</div>
...
function setMvt(id, type, nom, unite) {
    document.getElementById('formMvt').action = '<?= BASE_URL ?>/menage/inventaire/mouvement/' + id;
...
<script>new DataTableWithPagination('inventaireTable', { rowsPerPage: 25, searchInputId: 'searchInput', filters: [{ id: 'filterSection', column: 1 }], paginationId: 'paginationInv', infoId: 'tableInfoInv' });</script>
