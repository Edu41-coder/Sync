...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h2><i class="fas fa-calculator me-2 text-info"></i>Comptabilité Ménage — <?= $annee ?></h2>
        <form method="GET" class="d-flex gap-2 align-items-center">
            ...
            <button class="btn btn-sm btn-outline-info"><i class="fas fa-filter me-1"></i>Filtrer</button>
            <a href="<?= BASE_URL ?>/menage/comptabilite/export?residence_id=<?= $selectedResidence ?>&annee=<?= $annee ?>&mois=<?= $mois ?>" class="btn btn-sm btn-outline-success" title="Export CSV"><i class="fas fa-download"></i></a>
        </form>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= BASE_URL ?>/menage/fournisseurs<?= $selectedResidence ? '?residence_id='.$selectedResidence : '' ?>" class="btn btn-sm btn-outline-info">Voir fournisseurs</a>
                </div>
                <div class="card-body p-0">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><strong><?= htmlspecialchars($df['fournisseur_nom']) ?></strong></td>
                                <td class="text-center"><span class="badge bg-info"><?= $df['nb_commandes'] ?></span></td>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-info">
                <div class="card-header bg-info text-white"><h6 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Nouvelle écriture</h6></div>
                <form method="POST" action="<?= BASE_URL ?>/menage/comptabilite/ecriture">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-6"><label class="form-label small">Catégorie</label>
                                <select name="categorie" class="form-select form-select-sm" required>
                                    <option value="laverie_residents">Laverie résidents</option>
                        ...
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-6"><label class="form-label small">TVA %</label><input type="number" name="taux_tva" class="form-control form-control-sm" value="20" step="0.01" min="0"></div>
                        </div>
                        <div class="mb-2"><label class="form-label small">Compte comptable</label><input type="text" name="compte_comptable" class="form-control form-control-sm" placeholder="606100, 615100..."></div>
                    ...
                    <div class="card-footer"><button type="submit" class="btn btn-info btn-sm w-100"><i class="fas fa-save me-2"></i>Enregistrer</button></div>
                </form>
            </div>
        </div>
