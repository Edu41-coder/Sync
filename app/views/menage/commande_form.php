...
<div class="container-fluid py-4">
    ...
    <form method="POST" action="<?= BASE_URL ?>/menage/commandes/store" id="commandeForm">
        <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">

        <div class="row g-4">
            <div class="col-lg-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-info text-white"><h5 class="mb-0"><i class="fas fa-truck me-2"></i>Nouvelle Commande Ménage</h5></div>
                    <div class="card-body">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-info" onclick="addLigne()"><i class="fas fa-plus me-1"></i>Ajouter</button>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?= BASE_URL ?>/menage/commandes" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Annuler</a>
                        <button type="submit" class="btn btn-info"><i class="fas fa-save me-2"></i>Créer la commande</button>
                    </div>
                </div>
            </div>
        </div>
...
function addLigne() {
    ...
    tr.innerHTML = `
        ...
        <td><input type="number" name="lignes[${ligneIdx}][taux_tva]" class="form-control form-control-sm" value="20" step="0.1"></td>
