            ...
            <table class="table table-hover mb-0" id="produitsTable">
                ...
                <tbody>
                    ...
                    <tr class="<?= $p['actif'] ? '' : 'opacity-50' ?>">
                        ...
                        <td class="text-end">
                            <a href="<?= BASE_URL ?>/menage/produits/edit/<?= $p['id'] ?>" class="btn btn-sm btn-outline-primary" title="Modifier" data-bs-toggle="tooltip"><i class="fas fa-edit"></i></a>
                            <?php if ($p['actif']): ?>
                            <form method="POST" action="<?= BASE_URL ?>/menage/produits/delete/<?= $p['id'] ?>" class="d-inline" onsubmit="return confirm('Désactiver ?')">
            ...
            <form method="POST" action="<?= BASE_URL ?>/menage/produits/create">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label mb-2"><i class="fas fa-truck-loading me-1"></i><strong>Fournisseurs</strong> <small class="text-muted">(optionnel — peut être configuré après création)</small></label>
