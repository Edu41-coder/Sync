...
$breadcrumb = [
    ...
    ['icon' => 'fas fa-folder-open',    'text' => 'Mes Documents',   'url' => BASE_URL . '/residentDocument/index'],
];
foreach ($breadcrumbDocs as $i => $d) {
    ...
    $breadcrumb[] = [
        'icon' => 'fas fa-folder',
        'text' => $d['nom'],
        'url'  => $isLast ? null : BASE_URL . '/residentDocument/index/' . $d['id'],
    ];
}
...
function formatOctetsResident(int $o): string {
...
function iconeMimeResident(?string $mime): string {
...
function estPreviewableResident(?string $mime): bool {
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-lg-8">
            <h1 class="h3 mb-1"><i class="fas fa-folder-open text-warning me-2"></i> Mes Documents</h1>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <strong><?= formatOctetsResident($stats['quota_utilise']) ?> / <?= formatOctetsResident($stats['quota_total']) ?></strong>
                    </div>
        ...
        <div class="card-body d-flex flex-wrap gap-2 align-items-center justify-content-between">
            <div>
                <?php if ($dossierCourant): ?>
                    <a href="<?= BASE_URL ?>/residentDocument/index<?= $parentRetourId ? '/' . $parentRetourId : '' ?>"
                            ...
                            <?php foreach ($dossiers as $d): ?>
                                <tr>
                                    <td data-sort="0_<?= htmlspecialchars($d['nom']) ?>">
                                        <a href="<?= BASE_URL ?>/residentDocument/index/<?= $d['id'] ?>" class="text-decoration-none">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <a href="<?= BASE_URL ?>/residentDocument/index/<?= $d['id'] ?>"
                            ...
                            <?php foreach ($fichiers as $f): ?>
                                <tr>
                                    <td data-sort="1_<?= htmlspecialchars($f['nom_original']) ?>">
                                        <i class="<?= iconeMimeResident($f['mime_type']) ?> me-2"></i>
                                    ...
                                    <td class="text-end text-muted" data-sort="<?= $f['taille_octets'] ?>">
                                        <?= formatOctetsResident((int)$f['taille_octets']) ?>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <?php if (estPreviewableResident($f['mime_type'])): ?>
                                                <button class="btn btn-outline-info btn-preview"
                                                        data-url="<?= BASE_URL ?>/residentDocument/preview/<?= $f['id'] ?>"
                                            ...
                                            <?php endif; ?>
                                            <a href="<?= BASE_URL ?>/residentDocument/download/<?= $f['id'] ?>"
...
<div class="modal fade" id="modalNouveauDossier" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= BASE_URL ?>/residentDocument/createDossier">
...
<div class="modal fade" id="modalUpload" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= BASE_URL ?>/residentDocument/upload" enctype="multipart/form-data">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-text">
                        ...
                        <strong><?= formatOctetsResident($stats['quota_disponible']) ?></strong>
                    </div>
...
(function() {
    const BASE = '<?= BASE_URL ?>';
    const TAILLE_MAX = <?= ResidentDocument::TAILLE_MAX_FICHIER ?>;
    ...
    document.querySelectorAll('.btn-renameDossier').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('formRenameDossier').action = BASE + '/residentDocument/renameDossier/' + id;
    ...
    document.querySelectorAll('.btn-deleteDossier').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('formDeleteDossier').action = BASE + '/residentDocument/deleteDossier/' + id;
    ...
    document.querySelectorAll('.btn-deleteFichier').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('formDeleteFichier').action = BASE + '/residentDocument/deleteFichier/' + id;
