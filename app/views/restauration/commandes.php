...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-truck me-2 text-primary"></i>Commandes Fournisseurs</h2>
        <div class="d-flex gap-2">
            <?php if ($isManager): ?>
            <a href="<?= BASE_URL ?>/restauration/commandes/create" class="btn btn-warning"><i class="fas fa-plus me-2"></i>Nouvelle commande</a>
            <?php endif; ?>
        ...
        <div class="card-body p-0">
            <table class="table table-hover mb-0" id="commandesTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="<?= BASE_URL ?>/restauration/commandes/show/<?= $c['id'] ?>" class="fw-bold"><?= htmlspecialchars($c['numero_commande']) ?></a></td>
                        ...
                        <td class="text-center">
                            <a href="<?= BASE_URL ?>/restauration/commandes/show/<?= $c['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
