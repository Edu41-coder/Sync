<?php
/**
 * Partial liste des commandes d'un module.
 * Attend : $modulePath, $moduleLabel, $moduleColor, $commandes, $statut (filtre actuel)
 */
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h2 class="mb-0"><i class="fas fa-truck me-2 text-<?= htmlspecialchars($moduleColor) ?>"></i>Commandes <?= htmlspecialchars($moduleLabel) ?></h2>
        <a href="<?= BASE_URL ?>/<?= htmlspecialchars($modulePath) ?>/commandes/create" class="btn btn-<?= htmlspecialchars($moduleColor) ?>">
